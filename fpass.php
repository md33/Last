...
$secret = '6Ld4TCATAAAAAH-H1apMklFeZvGrHUfVkE0roWu0';
...
if(isset($_POST['btn-submit']))
{
 	if(isset($_POST['g-recaptcha-response']))
 	{
        ...
        $response=json_decode(file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6Ld4TCATAAAAAH-H1apMklFeZvGrHUfVkE0roWu0 &response=".$captcha."&remoteip=".$_SERVER['REMOTE_ADDR']), true);
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post">
        ...
        <input type="email" class="input-block-level" placeholder="И-майл хаяг" name="txtemail" required />
     	...
     	<div class="g-recaptcha" data-sitekey="6Ld4TCATAAAAALNzJGJzCXDgM2KcErh7c8cWo7oy" ></div>
     	<!--<?php
          require_once('recaptchalib.php');
          $publickey = "6LdJSSATAAAAANUmA-KvNEI53xm4Oaz1hQ85C0fG"; // you got this from the signup page
